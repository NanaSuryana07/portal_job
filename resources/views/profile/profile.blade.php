    ...
    <div class="container col-md-8">
        <div class="row" style="background-color:white;border-radius:25px;border:20px solid white">
            ...
            <div class="col-md-8">
                ...
                <div>
                    <a href="{{asset($profile->cv)}}" target="_blank" class="btn btn-outline-primary"><i class="fas fa-eye    "></i> Show CV</a>
                    <a href="{{ route('profiles.edit') }}" class="btn btn-outline-success"><i class="fas fa-user-edit    "></i> Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
